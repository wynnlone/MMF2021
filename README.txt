...
## 2021/6/1-: (ref: Analysis - Hypothetical_Scenarios_Analysis_Run1.xlsx and Hypothetical_Scenarios_Analysis_Run2.xlsx)
...
## Two types of scenario is created: historical and hypothetical (ref: code\Scenarios_Run2, Analysis\Hypothetical_Scenarios_Analysis_Run2)
...
## Risk metrics (ref: Analysis\VaR_analysis_run2.xlsx), Scenario metrics (ref: code\Scenarios_Run2, Analysis\Hypothetical_Scenarios_Analysis_Run2)
...
# Folder: Scenario_Data ==========================
# Including the datasets which will be used in the code of Scenarios_Run1 and Scenarios_Run2. 

## ecodata.csv: historical data of Macroeconomic indices
## ecodata_new.csv: the dataset which used to run regression with the historical factor data in Base case.
## ecodata_new_up.csv: the dataset which used to run regression with the historical factor data in Upside case.
## ecodata_new_down.csv: the dataset which used to run regression with the historical factor data in Downside case.
